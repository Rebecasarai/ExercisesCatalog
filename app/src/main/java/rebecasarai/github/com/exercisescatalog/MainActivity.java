...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Se inicializa el toolbar
     * Mostrará y esconderá el toolbar
     */
    ...
    private void prepareAlbums() {
        ...
        a = new Exercises("Calculate with RadioButtons", "Have fun finding the matches", covers[2]);
        exercisesList.add(a);
    ...
    /**
     * Decoración de la decoración del RecyclerView - margin igual alrededor
     */
